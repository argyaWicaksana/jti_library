                ...
                <div class="home-tab">
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-success mt-3" style="margin-left: 10px;" href="{{ route('transaction.index') }}" target="_blank">Back</a>
                            </li>
                            <li class="nav-item">
                                <p style="font-size: 15px; margin-top: 20px;">{{ $trans->total() }} Transaction Found</p>
                            </li>
